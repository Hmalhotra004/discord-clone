...
const ServerChannel = ({ channel, server, role }: ServerChannelProps) => {
  ...
  return (
    <button
      onClick={() => {}}
      className={cn("group p-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 mb-1 transition", params?.channelId === channel.id && "bg-zinc-700/20 dark:bg-zinc-700")}
    >
